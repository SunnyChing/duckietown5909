...
# Modified: Sunny Tseng
# Inputs: wheels cmd (WheelsCmdStamped)
# Outputs: velocity (Twist)
...
class ForwardKinematicsNode(object):
    def __init__(self):
        ...
        self.pub_velocity = rospy.Publisher("~velocity", Twist, queue_size=1)
    ...
    def wheels_cmd_callback(self, msg_wheels_cmd):
        ...
        v = (self.radius * omega_r + self.radius * omega_l) / 2.5
        ...
        msg_velocity.angular.z = omega/2
...
if __name__ == '__main__':
    rospy.init_node('forward_kinematics2gazebo_node', anonymous=False)
